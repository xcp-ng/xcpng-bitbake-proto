...
RDEPENDS:rubygem-rspec-core = "ruby(rubygems) ( ) /usr/bin/ruby ( ) /usr/bin/env ( ) rubygem(rake) ( ) rubygem(rspec-support) ( with  (REL))"
RPROVIDES:rubygem-rspec-core = "rubygem(rspec-core) ( =  3.13.0) rubygem-rspec-core ( =  3.13.0-3.el10)"
...
RDEPENDS:rubygem-rspec-core-doc = "rubygem-rspec-core ( =  3.13.0-3.el10)"
RPROVIDES:rubygem-rspec-core-doc = "rubygem-rspec-core-doc ( =  3.13.0-3.el10)"
