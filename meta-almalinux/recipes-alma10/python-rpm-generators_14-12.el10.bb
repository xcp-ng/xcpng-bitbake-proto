...
RDEPENDS:python3-rpm-generators = "/usr/bin/python3 ( ) python3-packaging ( ) python-srpm-macros ( >=  3.10-15) rpm ( >  4.15.90-0)"
RPROVIDES:python3-rpm-generators = "python3-rpm-generators ( =  14-12.el10)"
