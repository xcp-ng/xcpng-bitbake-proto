...
RDEPENDS:rubygem-kramdown-parser-gfm = "ruby(rubygems) ( ) rubygem(kramdown) ( with  (REL))"
RPROVIDES:rubygem-kramdown-parser-gfm = "rubygem-kramdown-parser-gfm ( =  1.1.0-14.el10) rubygem(kramdown-parser-gfm) ( =  1.1.0)"
...
RDEPENDS:rubygem-kramdown-parser-gfm-doc = "rubygem-kramdown-parser-gfm ( =  1.1.0-14.el10)"
RPROVIDES:rubygem-kramdown-parser-gfm-doc = "rubygem-kramdown-parser-gfm-doc ( =  1.1.0-14.el10)"
