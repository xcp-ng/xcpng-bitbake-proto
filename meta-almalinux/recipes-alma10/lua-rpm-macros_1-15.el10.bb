...
RDEPENDS:lua-rpm-macros = "lua-srpm-macros ( =  1-15.el10)"
RPROVIDES:lua-rpm-macros = "rpm_macro(lua_libdir) ( ) rpm_macro(lua_pkgdir) ( ) lua-rpm-macros ( =  1-15.el10)"
...
RDEPENDS:lua-srpm-macros = "rpm ( )"
RPROVIDES:lua-srpm-macros = "rpm_macro(lua_requires) ( ) rpm_macro(lua_version) ( ) lua-srpm-macros ( =  1-15.el10)"
