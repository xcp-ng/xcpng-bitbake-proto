...
RDEPENDS:gnome-shell-extension-dash-to-dock = "gnome-shell-extension-common ( )"
RPROVIDES:gnome-shell-extension-dash-to-dock = "gnome-shell-extension-dash-to-dock ( =  99-2.el10)"
