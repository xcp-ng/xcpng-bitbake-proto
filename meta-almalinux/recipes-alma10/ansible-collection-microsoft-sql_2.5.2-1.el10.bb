...
RDEPENDS:ansible-collection-microsoft-sql = "/usr/bin/bash ( ) rhel-system-roles ( ) ansible-core ( or  (REL))"
RPROVIDES:ansible-collection-microsoft-sql = "ansible-collection(microsoft.sql) ( =  2.5.2) ansible-collection-microsoft-sql ( =  2.5.2-1.el10)"
