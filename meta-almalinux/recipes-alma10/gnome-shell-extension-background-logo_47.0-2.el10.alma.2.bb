...
RDEPENDS:gnome-shell-extension-background-logo = "system-logos ( ) gnome-shell ( >=  47)"
RPROVIDES:gnome-shell-extension-background-logo = "gnome-shell-extension-background-logo ( =  47.0-2.el10.alma.2)"
