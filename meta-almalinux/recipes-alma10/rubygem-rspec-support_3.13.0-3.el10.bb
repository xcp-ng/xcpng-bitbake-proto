...
RDEPENDS:rubygem-rspec-support = "ruby(rubygems) ( )"
RPROVIDES:rubygem-rspec-support = "rubygem(rspec-support) ( =  3.13.0) rubygem-rspec-support ( =  3.13.0-3.el10)"
...
RDEPENDS:rubygem-rspec-support-doc = "rubygem-rspec-support ( =  3.13.0-3.el10)"
RPROVIDES:rubygem-rspec-support-doc = "rubygem-rspec-support-doc ( =  3.13.0-3.el10)"
