...
RDEPENDS:jdepend = "javapackages-filesystem ( )"
RPROVIDES:jdepend = "jdepend ( =  2.10-12.el10) mvn(jdepend:jdepend) ( =  2.10)"
...
RDEPENDS:jdepend-javadoc = "javapackages-filesystem ( )"
RPROVIDES:jdepend-javadoc = "jdepend-javadoc ( =  2.10-12.el10)"
