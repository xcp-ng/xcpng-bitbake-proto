...
RDEPENDS:rubygem-rspec-mocks = "ruby(rubygems) ( ) rubygem(rspec-support) ( with  (REL)) rubygem(diff-lcs) ( with  (REL))"
RPROVIDES:rubygem-rspec-mocks = "rubygem(rspec-mocks) ( =  3.13.0) rubygem-rspec-mocks ( =  3.13.0-3.el10)"
...
RDEPENDS:rubygem-rspec-mocks-doc = "rubygem-rspec-mocks ( =  3.13.0-3.el10)"
RPROVIDES:rubygem-rspec-mocks-doc = "rubygem-rspec-mocks-doc ( =  3.13.0-3.el10)"
