...
RDEPENDS:rubygem-rouge = "/usr/bin/ruby ( ) ruby(rubygems) ( )"
RPROVIDES:rubygem-rouge = "rubygem-rouge ( =  4.2.0-3.el10) rubygem(rouge) ( =  4.2.0)"
...
RDEPENDS:rubygem-rouge-doc = "rubygem-rouge ( =  4.2.0-3.el10)"
RPROVIDES:rubygem-rouge-doc = "rubygem-rouge-doc ( =  4.2.0-3.el10)"
