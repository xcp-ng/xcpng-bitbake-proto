...
RDEPENDS:perl-ExtUtils-Config = "perl(strict) ( ) perl(warnings) ( ) perl(Config) ( ) perl-libs ( ) perl(Data::Dumper) ( )"
RPROVIDES:perl-ExtUtils-Config = "perl(ExtUtils::Config) ( =  0.008) perl-ExtUtils-Config ( =  0.008-32.el10)"
