...
RDEPENDS:hunspell-lb = "hunspell-filesystem ( )"
RPROVIDES:hunspell-lb = "hunspell-lb ( =  0.20121128-26.el10)"
...
RDEPENDS:mythes-lb = "mythes ( )"
RPROVIDES:mythes-lb = "mythes-lb ( =  0.20121128-26.el10)"
